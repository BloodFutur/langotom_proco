...
HD_PWD='/home/rbonnet/Documents/4A/projet_info/ALU_8bits/ALU_8bits.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_8bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_8bits.tcl
