...
HD_PWD='/home/rbonnet/Documents/4A/projet_info/ALU_8bits/ALU_8bits.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_8bits.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU_8bits.tcl -notrace
